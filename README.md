...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-8derleq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-8derleq.containers.anotherwebservice.com/
...
```
git clone git@github.com:euluan1912/container-8derleq.git
cd container-8derleq
```
...
```
docker attach container-8derleq
```
